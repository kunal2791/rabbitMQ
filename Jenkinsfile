        ...
        properties([buildDiscarder(logRotator(artifactDaysToKeepStr: '', artifactNumToKeepStr: '', daysToKeepStr: '30', numToKeepStr: '15')),
            ...
            stage("Check Ansible installation") {
                                               dir("${ScriptPath}"){
                                                               ...
                                                               sh 'ssh ec2-user@demojump "cat /etc/ansible/hosts"'
																														//	 sh 'ssh ec2-user@demojump "mkdir ansible"'
																															 sh 'scp -r /data/jenkins/workspace/DevOps-RabbitMQ_Upgrade_Job/ ec2-user@demojump:/home/ec2-user/ansible'
                                                               }
                                               }
                                               ...
                                               dir("${ScriptPath}"){
                                                               ...
                                                               sh 'ssh ec2-user@demojump "ansible-playbook $FILE --check"'
                                                                                           }
                                               }

                                               stage("Installation") {
                                                               dir("${ScriptPath}"){
																															sh 'ssh ec2-user@demojump "ansible-playbook $FILE -s -v"'
